...
public class LoadingScreen extends AbstractScreen {
	...
	protected void loadAssets() {
		...
		game.assetManager.load("images/BG_UpgradeList_AdditionalTiles.png",
				Texture.class);
		game.assetManager
				.load("images/BG_UpgradeList_Tiles.png", Texture.class);
		...
		game.assetManager.load("images/Drawer_HomeTab_ResourceList.png",
				Texture.class);
	...
	protected void initActors() {
		...
		LabelStyle style = new LabelStyle(game.assetManager.get(
				"font/tycoons.fnt", BitmapFont.class), Color.WHITE);
		label = new Label("Loading...", style);
		label.setPosition(VIEWPORT_WIDTH / 2 - label.getWidth() / 2,
				VIEWPORT_HEIGHT / 2 + label.getHeight());
		stage.addActor(label);
		addLoadingBar();
	}

	private void addLoadingBar() {
		TextureAtlas atlas = game.assetManager.get(
				"images/images-packed.atlas", TextureAtlas.class);
		loadingBar = new GameProgressBar(0, 1000, 1,
